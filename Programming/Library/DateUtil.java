...
public class DateUtil
{
   ...
   public static void setShortDatePattern(String newShortDatePattern)
   {
       shortDatePattern = newShortDatePattern;
   }
      public static String getLongDatePattern()
   {
       return longDatePattern;
   }
   public static void setLongDatePattern(String newLongDatePattern)
   {
       longDatePattern = newLongDatePattern;
   }
}
